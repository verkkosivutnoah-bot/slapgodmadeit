...
export const freePacks: Pack[] = [
  withCover({
    ...
    type: "Free Kit",
    price: 0,
    tagline: "5 free live guitar loops from the Vault.",
    description:
      "A free taste of SLAPGOD Guitar Vault Vol. 1 — five original guitar loops. Enter your email, confirm the double opt-in link in your inbox, and the download is yours.",
    soundCount: 5,
    soundLabel: "5 loops",
    specs: ["WAV 24-bit / 48kHz", "BPM + key in filenames", "Royalty-free*"],
    genres: ["Trap", "R&B", "Latin"],
    bpmRange: "100",
    categories: [{ name: "Guitar loops", count: 5, unit: "loops" }],
    badge: "FREE",
    featured: true,
